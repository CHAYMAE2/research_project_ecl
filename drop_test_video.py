...
video_path = r'C:\Users\Lenovo Thinkpad T490\OneDrive\Bureau\research_project\vids_project\textu_dendrimere_tilt.avi'
...
# Preprocessing (median blur)
    ...
    threshold_area = 700 # Adjust as needed
...
# Detecting the water drop
    ...
    for contour in contours:
        ...
        if area > threshold_area:
            cv2.drawContours(frame, [contour], -1, (255, 0, 0), 2)  # Green color
